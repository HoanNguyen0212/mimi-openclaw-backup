...
- **Lưu ý nâng cấp (2026-03-16):** Google ra mắt `gemini-embedding-2-preview`. Đây là model đa phương thức natively multimodal đầu tiên (xử lý chung text, image, video, audio, PDF vào một vector space). Cần cân nhắc nâng cấp ClawBrain lên bản này để hỗ trợ Multimodal RAG và tối ưu dimension (xuống 1536/768) nhằm tiết kiệm tài nguyên Termux.
